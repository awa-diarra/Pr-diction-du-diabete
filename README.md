...
## Desciption
Projet de Machine Learning pour prédire le diabète chez des patients 
à partir de données médicales. Ce projet compare deux modèles : 
...
- Random Forest: Accuracy: 89.1% | Recall: 85.5%
...
## Notebook Kaggle
  [Voir le notebook complet](https://www.kaggle.com/code/diarraawa06/pr-diction-diab-te-decision-tree-vs-random-forest)
